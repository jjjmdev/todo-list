...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;CACC,mBAAmB;AACpB;;AAEA;CACC,mBAAmB;AACpB;;AAEA;CACC,kBAAkB;AACnB","sourcesContent":["@import \"https://cdn.jsdelivr.net/npm/bulma@1.0.2/css/bulma.min.css\";\n\n.message-extras > * {\n\tmargin-left: 0.8rem;\n}\n\n.message-title .tag {\n\tmargin-left: 0.5rem;\n}\n\n.message-body .tags {\n\tmargin-top: 0.5rem;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */ });
/* harmony import */ var _app_logic_logic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../app_logic/logic */ "./src/app_logic/logic.js");
...
function renderDeleteModal(index) {
	const { title } = (0,_app_logic_logic__WEBPACK_IMPORTED_MODULE_0__.itemByIndex)(index);
	...
	modalConfirm.addEventListener("click", function () {
		// call pang delete
		(0,_app_logic_logic__WEBPACK_IMPORTED_MODULE_0__.deleteItemByIndex)(index);
		modal.remove();
...
function renderItems(projects, selectedProject) {
...
/* harmony import */ var _items_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./items.js */ "./src/dom/items.js");
...
function renderDom() {
	const projects = _app_logic_logic_js__WEBPACK_IMPORTED_MODULE_2__.projects.projects;
	let projectNames = [];
	...
	container.innerHTML = "";
	container.append(
		(0,_nav_js__WEBPACK_IMPORTED_MODULE_0__.renderNav)(projectNames),
		(0,_items_js__WEBPACK_IMPORTED_MODULE_1__.renderItems)(projects, projectNames[0])
	);
...
console.log("Hello");
console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(2024, 1, 11), "MM/dd/yyyy"));
